...
class Task(BaseModel):
    ...
    bullets: List[str] = Field(..., description="3-6 concrete takeaways, narrative points, or arguments.")
...
class Plan(BaseModel):
    ...
    audience: str = Field(..., description="Target audience (e.g., curious generalists, seasoned developers, product managers, founders).")
    ...
    ] = Field(default="explainer", description="The genre and format of the writeup.")
